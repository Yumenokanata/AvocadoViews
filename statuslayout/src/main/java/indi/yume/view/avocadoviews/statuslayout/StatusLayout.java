package indi.yume.view.avocadoviews.statuslayout;
...
public class StatusLayout extends FrameLayout {
    ...
    public StatusLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs != null)
            init(context.obtainStyledAttributes(attrs, R.styleable.StatusLayout, defStyleAttr, 0));
    ...
    private void init(TypedArray tArray) {
        try {
            int emptyViewLayoutResId = tArray.getResourceId(R.styleable.StatusLayout_sl_emptyView, -1);
            int uselessViewLayoutResId = tArray.getResourceId(R.styleable.StatusLayout_sl_uselessView, -1);
            int errorViewLayoutResId = tArray.getResourceId(R.styleable.StatusLayout_sl_errorView, -1);
            int loadingViewLayoutResId = tArray.getResourceId(R.styleable.StatusLayout_sl_loadingView, -1);
            int defaultShowMode = tArray.getInt(R.styleable.StatusLayout_sl_defaultShowMode, 0);
            int editModeShowMode = tArray.getInt(R.styleable.StatusLayout_sl_toolShowMode, 0);
